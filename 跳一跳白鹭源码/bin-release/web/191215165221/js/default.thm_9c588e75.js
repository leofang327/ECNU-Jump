window.skins={};
	...
	function GameSceneSkin() {
		_super.call(this);
		this.skinParts = ["background","player","scoreLabel","blockPanel","overScoreLabel","restart","overPanel"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this.background_i(),this.blockPanel_i(),this.overPanel_i()];
	}
